"""
Run OCR-to-CO2 on a clothing tag image.
 
This script uses EasyOCR to extract text from one or more tag images, parses the
extracted text into a structured record (materials, origin, care), and estimates
a CO2 footprint.

Example usage (from full_demo/code):
single image:
- python demo.py --image ../cropped_tags/tag_1.JPG
multiple images:
- python demo.py --image ../cropped_tags/tag_1.JPG --image ../cropped_tags/tag_2.JPG
"""
