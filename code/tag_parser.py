"""
This script uses regex to extract information from tag images
- material composition (e.g., "100% cotton")
- origin country (e.g., "made in guatemala")
- basic care settings (wash temperature, drying method, dry clean)

Returns a TagRecord object
"""
